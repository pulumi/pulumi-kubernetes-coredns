...
class CoreDNSArgs:
    def __init__(__self__, *,
                 ...
                 autoscaler: pulumi.Input[Optional['CoreDNSAutoscalerArgs']] = None,
                 autoscaling: pulumi.Input[Optional['pulumi_kubernetes.autoscaling.v2beta2.HorizontalPodAutoscalerSpecArgs']] = None,
                 deployment: pulumi.Input[Optional['CoreDNSDeploymentArgs']] = None,
                 extra_secrets: pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_kubernetes.core.v1.VolumeMountArgs']]]] = None,
                 ...
                 helm_options: pulumi.Input[Optional['ReleaseArgs']] = None,
                 hpa: pulumi.Input[Optional['CoreDNSHPAArgs']] = None,
                 image: pulumi.Input[Optional['CoreDNSImageArgs']] = None,
                 is_cluster_service: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 pod_disruption_budget: pulumi.Input[Optional['pulumi_kubernetes.policy.v1.PodDisruptionBudgetSpecArgs']] = None,
                 pre_stop_sleep: pulumi.Input[Optional[_builtins.int]] = None,
                 priority_class_name: pulumi.Input[Optional[_builtins.str]] = None,
                 prometheus: pulumi.Input[Optional['CoreDNSPrometheusArgs']] = None,
                 rbac: pulumi.Input[Optional['CoreDNSRBACArgs']] = None,
                 ...
                 rolling_update: pulumi.Input[Optional['pulumi_kubernetes.apps.v1.RollingUpdateDeploymentArgs']] = None,
                 servers: pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerArgs']]]] = None,
                 service: pulumi.Input[Optional['CoreDNSServiceArgs']] = None,
                 service_account: pulumi.Input[Optional['CoreDNSServiceAccountArgs']] = None,
                 ...
                 zone_files: pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSZoneFileArgs']]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.bool] is_cluster_service: Specifies whether chart should be deployed as cluster-service or normal k8s app.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] node_selector: Node labels for pod assignment.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] pod_annotations: Optional Pod only Annotations.
        ...
        :param pulumi.Input[_builtins.int] pre_stop_sleep: Under heavy load it takes more that standard time to remove Pod endpoint from a cluster. This will delay termination of our pod by `preStopSleep`. To make sure kube-proxy has enough time to catch up.
        :param pulumi.Input[_builtins.str] priority_class_name: Optional priority class to be used for the coredns pods. Used for autoscaler if autoscaler.priorityClassName not set.
        ...
        :param pulumi.Input[_builtins.str] service_type: Kubernetes Service type.
        :param pulumi.Input[_builtins.int] termination_grace_period_seconds: Optional duration in seconds the pod needs to terminate gracefully.
    ...
    @_builtins.property
    @pulumi.getter
    def autoscaler(self) -> pulumi.Input[Optional['CoreDNSAutoscalerArgs']]:
        """
    ...
    @autoscaler.setter
    def autoscaler(self, value: pulumi.Input[Optional['CoreDNSAutoscalerArgs']]):
        pulumi.set(self, "autoscaler", value)

    @_builtins.property
    @pulumi.getter
    def autoscaling(self) -> pulumi.Input[Optional['pulumi_kubernetes.autoscaling.v2beta2.HorizontalPodAutoscalerSpecArgs']]:
        """
    ...
    @autoscaling.setter
    def autoscaling(self, value: pulumi.Input[Optional['pulumi_kubernetes.autoscaling.v2beta2.HorizontalPodAutoscalerSpecArgs']]):
        pulumi.set(self, "autoscaling", value)

    @_builtins.property
    @pulumi.getter
    def deployment(self) -> pulumi.Input[Optional['CoreDNSDeploymentArgs']]:
        """
    ...
    @deployment.setter
    def deployment(self, value: pulumi.Input[Optional['CoreDNSDeploymentArgs']]):
        pulumi.set(self, "deployment", value)

    @_builtins.property
    @pulumi.getter(name="extraSecrets")
    def extra_secrets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_kubernetes.core.v1.VolumeMountArgs']]]]:
        """
    ...
    def extra_secrets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_kubernetes.core.v1.VolumeMountArgs']]]]):
    ...
    def helm_options(self) -> pulumi.Input[Optional['ReleaseArgs']]:
        """
    ...
    @helm_options.setter
    def helm_options(self, value: pulumi.Input[Optional['ReleaseArgs']]):
        pulumi.set(self, "helm_options", value)

    @_builtins.property
    @pulumi.getter
    def hpa(self) -> pulumi.Input[Optional['CoreDNSHPAArgs']]:
        """
    ...
    @hpa.setter
    def hpa(self, value: pulumi.Input[Optional['CoreDNSHPAArgs']]):
    ...
    def is_cluster_service(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def is_cluster_service(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def pod_disruption_budget(self) -> pulumi.Input[Optional['pulumi_kubernetes.policy.v1.PodDisruptionBudgetSpecArgs']]:
        """
    ...
    def pod_disruption_budget(self, value: pulumi.Input[Optional['pulumi_kubernetes.policy.v1.PodDisruptionBudgetSpecArgs']]):
        pulumi.set(self, "pod_disruption_budget", value)

    @_builtins.property
    @pulumi.getter(name="preStopSleep")
    def pre_stop_sleep(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def pre_stop_sleep(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    @_builtins.property
    @pulumi.getter
    def prometheus(self) -> pulumi.Input[Optional['CoreDNSPrometheusArgs']]:
        """
    ...
    @prometheus.setter
    def prometheus(self, value: pulumi.Input[Optional['CoreDNSPrometheusArgs']]):
        pulumi.set(self, "prometheus", value)

    @_builtins.property
    @pulumi.getter
    def rbac(self) -> pulumi.Input[Optional['CoreDNSRBACArgs']]:
        """
    ...
    @rbac.setter
    def rbac(self, value: pulumi.Input[Optional['CoreDNSRBACArgs']]):
    ...
    def rolling_update(self) -> pulumi.Input[Optional['pulumi_kubernetes.apps.v1.RollingUpdateDeploymentArgs']]:
        return pulumi.get(self, "rolling_update")

    @rolling_update.setter
    def rolling_update(self, value: pulumi.Input[Optional['pulumi_kubernetes.apps.v1.RollingUpdateDeploymentArgs']]):
        pulumi.set(self, "rolling_update", value)

    @_builtins.property
    @pulumi.getter
    def servers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerArgs']]]]:
        """
    ...
    @servers.setter
    def servers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerArgs']]]]):
        pulumi.set(self, "servers", value)

    @_builtins.property
    @pulumi.getter
    def service(self) -> pulumi.Input[Optional['CoreDNSServiceArgs']]:
        """
    ...
    @service.setter
    def service(self, value: pulumi.Input[Optional['CoreDNSServiceArgs']]):
        pulumi.set(self, "service", value)

    @_builtins.property
    @pulumi.getter(name="serviceAccount")
    def service_account(self) -> pulumi.Input[Optional['CoreDNSServiceAccountArgs']]:
        """
    ...
    def service_account(self, value: pulumi.Input[Optional['CoreDNSServiceAccountArgs']]):
    ...
    def zone_files(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSZoneFileArgs']]]]:
        """
    ...
    @zone_files.setter
    def zone_files(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSZoneFileArgs']]]]):
...
class CoreDNS(pulumi.ComponentResource):
    ...
    def __init__(__self__,
                 ...
                 autoscaler: pulumi.Input[Optional[Union['CoreDNSAutoscalerArgs', 'CoreDNSAutoscalerArgsDict']]] = None,
                 autoscaling: pulumi.Input[Optional[pulumi.InputType['pulumi_kubernetes.autoscaling.v2beta2.HorizontalPodAutoscalerSpecArgs']]] = None,
                 deployment: pulumi.Input[Optional[Union['CoreDNSDeploymentArgs', 'CoreDNSDeploymentArgsDict']]] = None,
                 extra_secrets: pulumi.Input[Optional[Sequence[pulumi.Input[pulumi.InputType['pulumi_kubernetes.core.v1.VolumeMountArgs']]]]] = None,
                 ...
                 helm_options: pulumi.Input[Optional[Union['ReleaseArgs', 'ReleaseArgsDict']]] = None,
                 hpa: pulumi.Input[Optional[Union['CoreDNSHPAArgs', 'CoreDNSHPAArgsDict']]] = None,
                 image: pulumi.Input[Optional[Union['CoreDNSImageArgs', 'CoreDNSImageArgsDict']]] = None,
                 is_cluster_service: pulumi.Input[Optional[_builtins.bool]] = None,
                 liveness_probe: pulumi.Input[Optional[pulumi.InputType['pulumi_kubernetes.core.v1.ProbeArgs']]] = None,
                 node_selector: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 pod_annotations: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 pod_disruption_budget: pulumi.Input[Optional[pulumi.InputType['pulumi_kubernetes.policy.v1.PodDisruptionBudgetSpecArgs']]] = None,
                 pre_stop_sleep: pulumi.Input[Optional[_builtins.int]] = None,
                 priority_class_name: pulumi.Input[Optional[_builtins.str]] = None,
                 prometheus: pulumi.Input[Optional[Union['CoreDNSPrometheusArgs', 'CoreDNSPrometheusArgsDict']]] = None,
                 rbac: pulumi.Input[Optional[Union['CoreDNSRBACArgs', 'CoreDNSRBACArgsDict']]] = None,
                 readiness_probe: pulumi.Input[Optional[pulumi.InputType['pulumi_kubernetes.core.v1.ProbeArgs']]] = None,
                 replica_count: pulumi.Input[Optional[_builtins.int]] = None,
                 resources: pulumi.Input[Optional[pulumi.InputType['pulumi_kubernetes.core.v1.ResourceRequirementsArgs']]] = None,
                 rolling_update: pulumi.Input[Optional[pulumi.InputType['pulumi_kubernetes.apps.v1.RollingUpdateDeploymentArgs']]] = None,
                 servers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CoreDNSServerArgs', 'CoreDNSServerArgsDict']]]]] = None,
                 service: pulumi.Input[Optional[Union['CoreDNSServiceArgs', 'CoreDNSServiceArgsDict']]] = None,
                 service_account: pulumi.Input[Optional[Union['CoreDNSServiceAccountArgs', 'CoreDNSServiceAccountArgsDict']]] = None,
                 service_type: pulumi.Input[Optional[_builtins.str]] = None,
                 termination_grace_period_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 tolerations: pulumi.Input[Optional[Sequence[pulumi.Input[pulumi.InputType['pulumi_kubernetes.core.v1.TolerationArgs']]]]] = None,
                 zone_files: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CoreDNSZoneFileArgs', 'CoreDNSZoneFileArgsDict']]]]] = None,
                 __props__=None):
        """
