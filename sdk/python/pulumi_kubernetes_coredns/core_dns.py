...
class CoreDNSArgs:
    def __init__(__self__, *,
                 ...
                 is_cluster_service: Optional[pulumi.Input[_builtins.bool]] = None,
                 ...
                 pre_stop_sleep: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    def is_cluster_service(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def is_cluster_service(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def pre_stop_sleep(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def pre_stop_sleep(self, value: Optional[pulumi.Input[_builtins.int]]):
