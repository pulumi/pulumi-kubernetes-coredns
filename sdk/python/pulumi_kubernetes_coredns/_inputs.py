...
class CoreDNSAutoscalerArgsDict(TypedDict):
    ...
    """
    image: NotRequired[pulumi.Input[Optional['CoreDNSImageArgs']]]
    """
...
class CoreDNSHPAArgsDict(TypedDict):
    ...
    metrics: NotRequired[pulumi.Input[Optional['pulumi_kubernetes.autoscaling.v2beta2.MetricSpecArgs']]]
...
class CoreDNSPrometheusArgsDict(TypedDict):
    monitor: NotRequired[pulumi.Input[Optional['CoreDNSPrometheusMonitorArgs']]]
    service: NotRequired[pulumi.Input[Optional['CoreDNSPrometheusServiceArgs']]]
...
class CoreDNSServerArgsDict(TypedDict):
    plugins: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerPluginArgs']]]]]
    """
    ...
    """
    zones: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerZoneArgs']]]]]
    """
