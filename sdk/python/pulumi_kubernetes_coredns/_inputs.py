...
class CoreDNSAutoscalerArgsDict(TypedDict):
    cores_per_replica: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    image: NotRequired[pulumi.Input[Optional['CoreDNSImageArgsDict']]]
    """
    The image to pull from for the autoscaler.
    """
    include_unschedulable_nodes: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    nodes_per_replica: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Number of nodes in the cluster per coredns replica.
    """
    prevent_single_point_failure: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class CoreDNSAutoscalerArgs:
    def __init__(__self__, *,
                 cores_per_replica: pulumi.Input[Optional[_builtins.int]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 image: pulumi.Input[Optional['CoreDNSImageArgs']] = None,
                 include_unschedulable_nodes: pulumi.Input[Optional[_builtins.bool]] = None,
                 max: pulumi.Input[Optional[_builtins.int]] = None,
                 min: pulumi.Input[Optional[_builtins.int]] = None,
                 nodes_per_replica: pulumi.Input[Optional[_builtins.int]] = None,
                 prevent_single_point_failure: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.int] cores_per_replica: Number of cores in the cluster per coredns replica.
        :param pulumi.Input[_builtins.bool] enabled: Enabled the cluster-proportional-autoscaler.
        :param pulumi.Input['CoreDNSImageArgs'] image: The image to pull from for the autoscaler.
        :param pulumi.Input[_builtins.bool] include_unschedulable_nodes: Whether to include unschedulable nodes in the nodes/cores calculations - this requires version 1.8.0+ of the autoscaler.
        :param pulumi.Input[_builtins.int] max: Max size of replicaCount
        :param pulumi.Input[_builtins.int] min: Min size of replicaCount
        :param pulumi.Input[_builtins.int] nodes_per_replica: Number of nodes in the cluster per coredns replica.
        :param pulumi.Input[_builtins.bool] prevent_single_point_failure: If true does not allow single points of failure to form.
        """
    ...
    def cores_per_replica(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Number of cores in the cluster per coredns replica.
        """
    ...
    def cores_per_replica(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    @_builtins.property
    @pulumi.getter
    def image(self) -> pulumi.Input[Optional['CoreDNSImageArgs']]:
        """
        The image to pull from for the autoscaler.
        """
    ...
    @image.setter
    def image(self, value: pulumi.Input[Optional['CoreDNSImageArgs']]):
        pulumi.set(self, "image", value)

    @_builtins.property
    @pulumi.getter(name="includeUnschedulableNodes")
    def include_unschedulable_nodes(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to include unschedulable nodes in the nodes/cores calculations - this requires version 1.8.0+ of the autoscaler.
        """
    ...
    def include_unschedulable_nodes(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def nodes_per_replica(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Number of nodes in the cluster per coredns replica.
        """
    ...
    def nodes_per_replica(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "nodes_per_replica", value)

    @_builtins.property
    @pulumi.getter(name="preventSinglePointFailure")
    def prevent_single_point_failure(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If true does not allow single points of failure to form.
        """
    ...
    def prevent_single_point_failure(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class CoreDNSDeploymentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.bool] enabled: Optionally disable the main deployment and its respective resources.
        :param pulumi.Input[_builtins.str] name: Name of the deployment if deployment.enabled is true. Otherwise the name of an existing deployment for the autoscaler or HPA to target.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if name is not None:
...
class CoreDNSHPAArgsDict(TypedDict):
    ...
    metrics: NotRequired[pulumi.Input[Optional['pulumi_kubernetes.autoscaling.v2beta2.MetricSpecArgsDict']]]
...
class CoreDNSHPAArgs:
    def __init__(__self__, *,
                 ...
                 metrics: pulumi.Input[Optional['pulumi_kubernetes.autoscaling.v2beta2.MetricSpecArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def metrics(self) -> pulumi.Input[Optional['pulumi_kubernetes.autoscaling.v2beta2.MetricSpecArgs']]:
        return pulumi.get(self, "metrics")

    @metrics.setter
    def metrics(self, value: pulumi.Input[Optional['pulumi_kubernetes.autoscaling.v2beta2.MetricSpecArgs']]):
...
class CoreDNSImageArgsDict(TypedDict):
    ...
    Image pull policy.
    """
    pull_secrets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
...
class CoreDNSImageArgs:
    def __init__(__self__, *,
                 ...
                 pull_secrets: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] pull_secrets: Specify container image pull secrets.
        :param pulumi.Input[_builtins.str] repository: The image repository to pull from.
        :param pulumi.Input[_builtins.str] tag: The image tag to pull from.
        """
    ...
    def pull_secrets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Specify container image pull secrets.
        """
    ...
    @pull_secrets.setter
    def pull_secrets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
class CoreDNSPrometheusMonitorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] additional_labels: Additional labels that can be used so ServiceMonitor will be discovered by Prometheus.
        :param pulumi.Input[_builtins.bool] enabled: Set this to true to create ServiceMonitor for Prometheus operator.
        :param pulumi.Input[_builtins.str] namespace: Selector to select which namespaces the Endpoints objects are discovered from.
        """
...
class CoreDNSPrometheusServiceArgs:
    def __init__(__self__, *,
                 ...
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] annotations: Annotations to add to the metrics Service.
        :param pulumi.Input[_builtins.bool] enabled: Set this to true to create Service for Prometheus metrics.
        """
...
class CoreDNSPrometheusArgsDict(TypedDict):
    monitor: NotRequired[pulumi.Input[Optional['CoreDNSPrometheusMonitorArgsDict']]]
    service: NotRequired[pulumi.Input[Optional['CoreDNSPrometheusServiceArgsDict']]]

@pulumi.input_type
class CoreDNSPrometheusArgs:
    def __init__(__self__, *,
                 monitor: pulumi.Input[Optional['CoreDNSPrometheusMonitorArgs']] = None,
                 service: pulumi.Input[Optional['CoreDNSPrometheusServiceArgs']] = None):
    ...
    @_builtins.property
    @pulumi.getter
    def monitor(self) -> pulumi.Input[Optional['CoreDNSPrometheusMonitorArgs']]:
        return pulumi.get(self, "monitor")

    @monitor.setter
    def monitor(self, value: pulumi.Input[Optional['CoreDNSPrometheusMonitorArgs']]):
        pulumi.set(self, "monitor", value)

    @_builtins.property
    @pulumi.getter
    def service(self) -> pulumi.Input[Optional['CoreDNSPrometheusServiceArgs']]:
        return pulumi.get(self, "service")

    @service.setter
    def service(self, value: pulumi.Input[Optional['CoreDNSPrometheusServiceArgs']]):
...
class CoreDNSRBACArgsDict(TypedDict):
    ...
    """
    psp_enable: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class CoreDNSRBACArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 psp_enable: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.bool] create: If true, create & use RBAC resources
        :param pulumi.Input[_builtins.str] name: The name of the ServiceAccount to use. If not set and create is true, a name is generated using the fullname template.
        :param pulumi.Input[_builtins.bool] psp_enable: If true, create and use PodSecurityPolicy
        """
    ...
    def psp_enable(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If true, create and use PodSecurityPolicy
        """
    ...
    @psp_enable.setter
    def psp_enable(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "psp_enable", value)


class CoreDNSServerPluginArgsDict(TypedDict):
    config_block: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class CoreDNSServerPluginArgs:
    def __init__(__self__, *,
                 config_block: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 parameters: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] config_block: if the plugin supports extra block style config, supply it here
        :param pulumi.Input[_builtins.str] name: name of plugin, if used multiple times ensure that the plugin supports it!
        :param pulumi.Input[_builtins.str] parameters: list of parameters after the plugin
        """
    ...
    def config_block(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        if the plugin supports extra block style config, supply it here
        """
    ...
    @config_block.setter
    def config_block(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class CoreDNSServerZoneArgsDict(TypedDict):
    ...
    """
    use_tcp: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class CoreDNSServerZoneArgs:
    def __init__(__self__, *,
                 ...
                 use_tcp: pulumi.Input[Optional[_builtins.bool]] = None,
                 zone: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] scheme: optional, defaults to "" (which equals "dns://" in CoreDNS)
        :param pulumi.Input[_builtins.bool] use_tcp: set this parameter to optionally expose the port on tcp as well as udp for the DNS protocol. Note that this will not work if you are also exposing tls or grpc on the same server.
        :param pulumi.Input[_builtins.str] zone: optional, defaults to "."
        """
    ...
    @_builtins.property
    @pulumi.getter
    def use_tcp(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        set this parameter to optionally expose the port on tcp as well as udp for the DNS protocol. Note that this will not work if you are also exposing tls or grpc on the same server.
        """
    ...
    @use_tcp.setter
    def use_tcp(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class CoreDNSServerArgsDict(TypedDict):
    plugins: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerPluginArgsDict']]]]]
    """
    ...
    """
    zones: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerZoneArgsDict']]]]]
    """
...
class CoreDNSServerArgs:
    def __init__(__self__, *,
                 plugins: pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerPluginArgs']]]] = None,
                 port: pulumi.Input[Optional[_builtins.int]] = None,
                 zones: pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerZoneArgs']]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['CoreDNSServerPluginArgs']]] plugins: the plugins to use for this server block.
        :param pulumi.Input[_builtins.int] port: optional, defaults to "" (which equals 53 in CoreDNS).
    ...
    @_builtins.property
    @pulumi.getter
    def plugins(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerPluginArgs']]]]:
        """
        the plugins to use for this server block.
        """
    ...
    @plugins.setter
    def plugins(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerPluginArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def zones(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerZoneArgs']]]]:
        """
        the `zones` block can be left out entirely, defaults to "."
        """
    ...
    @zones.setter
    def zones(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['CoreDNSServerZoneArgs']]]]):
...
class CoreDNSServiceAccountArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.bool] create: If true, create & use serviceAccount.
        :param pulumi.Input[_builtins.str] name: The name of the ServiceAccount to use. If not set and create is true, a name is generated using the fullname template
        """
        if annotations is not None:
            pulumi.set(__self__, "annotations", annotations)
...
class CoreDNSServiceArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] annotations: Annotations to add to service.
        :param pulumi.Input[_builtins.str] cluster_ip: IP address to assign to service.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] external_ips: External IP addresses.
        :param pulumi.Input[_builtins.str] external_traffic_policy: Enable client source IP preservation.
        :param pulumi.Input[_builtins.str] load_balancer_ip: IP address to assign to load balancer (if supported).
        :param pulumi.Input[_builtins.str] name: The name of the Service. If not set, a name is generated using the fullname template.
        """
        if annotations is not None:
            pulumi.set(__self__, "annotations", annotations)
