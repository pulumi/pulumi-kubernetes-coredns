...
import com.pulumi.kubernetescoredns.ProviderArgs;
import com.pulumi.kubernetescoredns.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:kubernetes-coredns")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes-coredns", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
